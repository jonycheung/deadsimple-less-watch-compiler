...
- A watch folder that doesn't exist, isn't a directory, or can't be read/traversed stops the run with a message and a non-zero exit code, before any watching starts.
